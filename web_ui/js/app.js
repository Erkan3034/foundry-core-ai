    ...
    container.innerHTML = `
        <div class="hero" id="welcomeScreen">
            ...
            <div class="suggestions" id="suggestions">
                ...
                <button type="button" class="suggestion" data-quick="${t('suggestion3Query')}">
                    <span class="suggestion-icon"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.75"><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/></svg></span>
                    <span class="suggestion-body"><span class="suggestion-title">${t('suggestion3Title')}</span><span class="suggestion-desc">${t('suggestion3Desc')}</span></span>
                </button>
                <button type="button" class="suggestion" data-quick="${t('suggestion4Query')}">
                    <span class="suggestion-icon"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"/></svg></span>
                    <span class="suggestion-body"><span class="suggestion-title">${t('suggestion4Title')}</span><span class="suggestion-desc">${t('suggestion4Desc')}</span></span>
                </button>
            </div>
        </div>
    `;
